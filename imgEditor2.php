		...
		<div class="editor_content_inner">
			...
			<div class="editor_content_box editor_content_box4">
				...
				<table>
					<tr>
						<th>내용</th>
						<td><input type='text' name='addText' id='addText'><input type='button' value='텍스트추가'  onclick='addTextBox()' style="background:#ff0000;padding:10px;"></td>
					</tr>
					<tr>
						<th>폰트</th>
						<td>
								<select id="addfontfamily" name='addfontfamily'>
					...
					<tr>
						<th>크기</th>
						<td><input type='text' name='addFontsize' id='addFontsize'></td>
					</tr>
					<tr>
						<th>글색상</th>
						<td><input type='text' name='addfontcolor' id='addfontcolor'></td>
					</tr>
					<tr>
						<th>정렬</th>
						<td><input type='text' name='addalign' id='addfontcolor'></td>
					</tr>
					<tr>
						<th>크기/위치</th>
						<td>
							위에서<input type='text' name='addtop' id='addtop'><br/>
							죄에서<input type='text' name='addleft' id='addleft'><br/>
							가로<input type='text' name='addwidth' id='addwidth'><br/>
							세로<input type='text' name='addheight' id='addheight'><br/>
						</td>
					</tr>
				</table>
...
function addTextBox(){ 
		...
		console.log(addwidth,addheight,addtop,addleft);
